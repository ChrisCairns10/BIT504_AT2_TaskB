...
public class GameMain extends JPanel implements MouseListener{
	...
	// Creates the enumeration for the variable below (GameState currentState)
	...
	public GameMain() {   
		...
		// JPanel fires a MouseEvent on MouseClicked          
	    this.addMouseListener(this);
	    
		// Sets up the status bar (JLabel) to display status message       
	...
	public static void main(String[] args) {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				// Creates a main window to contain the panel
	...
	// Custom painting codes for JPanel
	...
	// Initialises the game-board contents and the current status of GameState and Player) 
